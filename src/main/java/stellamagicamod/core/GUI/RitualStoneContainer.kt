...
class RitualStoneContainer (private val x: Int, private val y: Int, private val z: Int, private val tile: TileStellaRitualStone, private val playerInventory: InventoryPlayer) : Container() {
    init {
        val i = -19
        for (j in 0..1) {
            for (k in 0..8) {
