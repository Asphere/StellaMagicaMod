package stellamagicamod.core.Energy.TileEntity

import net.minecraft.entity.player.EntityPlayer
import stellamagicamod.core.Energy.*
...
class TileStellaRitualStone(private var tier: Int) : TileEntity(), IInventory{
    ...
    private var voltage: APSV = APSV.ZeroSV
